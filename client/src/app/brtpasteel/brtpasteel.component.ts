...
@Component({
  selector: 'app-brtpasteel',
  templateUrl: './brtpasteel.component.html',
  styleUrls: ['./brtpasteel.component.css']
})
export class BrtpasteelComponent implements OnInit {

  private map: Map;
   private draw: OlDraw;
   brtWaterKaart = this.map;
  ...
  brtPastelTile = new WMTS({
   ...
   brtPastelLayer = new TileLayer({
     source: this.brtPastelTile,
     opacity: 0.7,
   });
